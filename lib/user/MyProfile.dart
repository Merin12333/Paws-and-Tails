...
class _EditProfileState extends State<EditProfile> { 
  ...
  Widget build(BuildContext context) { 
    return Scaffold( 
      appBar: AppBar( 
        title: Text('My Profile'),backgroundColor: Color.fromARGB(255, 201, 124, 10), 
        leading: IconButton( 
          icon: Icon( 
            Icons.arrow_back, 
            color: Colors.white, 
                    ...
                    Positioned( 
                      ...
                      child: Container( 
                        ...
                        decoration: BoxDecoration( 
                          ...
                          color: Color.fromARGB(255, 48, 16, 102) 
                        ), 
                        child: Icon( 
                          Icons.edit, 
                          color: Colors.white, 
                 ...
                 ElevatedButton( 
                  onPressed: () {}, 
                   ...
                   style: ElevatedButton.styleFrom( 
                    primary: Color.fromARGB(255, 201, 124, 10), 
                    padding: EdgeInsets.symmetric(horizontal: 50), 
                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)) 
                   ), 
                   ) 
  ...
  Widget buildTextField(String labelText, String placeholder, bool isPasswordTextField){ 
    ...
    decoration: InputDecoration( 
      focusedBorder: OutlineInputBorder( 
        ...
        borderSide:BorderSide(color:  Color.fromARGB(255, 48, 16, 102) , ), 
      ), 
      ...
      IconButton(onPressed: (){}, 
       ...
       labelStyle: TextStyle(color: Color.fromARGB(255, 48, 16, 102),fontSize: 20), 
       hintStyle: TextStyle( 
        fontSize: 12, 
        color: Colors.grey 
       ) 
...
Widget buildgender(){ 
    ...
    child: Row( 
              children:[ 
                Text(' Gender  ',style: TextStyle(fontSize: 16,color: Color.fromARGB(255, 48, 16, 102)),), 
                Radio(value: 'male', 
                             groupValue: gender,  
                             onChanged: (value){ 
                              setState(() { 
               ...
               Text("Male",style: TextStyle(fontSize: 16,color: Color.fromARGB(255, 48, 16, 102))), 
               Radio(value: 'female', 
                             groupValue: gender,  
                             onChanged: (value){ 
                              setState(() { 
               ...
               Text("Female",style: TextStyle(fontSize: 16,color: Color.fromARGB(255, 48, 16, 102))), 
               Radio(value: 'others', 
                             groupValue: gender,  
                             onChanged: (value){ 
                              setState(() { 
               ...
               Text("Others",style: TextStyle(fontSize: 16,color: Color.fromARGB(255, 48, 16, 102))), 
              ] 
              ), 
              ); 
  } 
